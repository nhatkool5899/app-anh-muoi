                ...
                <div class="card">
                    <div class="card-body">
                        <div class="box-title">
                            ...
                            <div><a href="{{route('sale.create')}}" class="btn-add"><i class="fa-solid fa-plus"></i> Thêm mới</a></div>
                        </div>
                        @if (session('status'))
                        ...
                        <table class="table table-striped table-style">
                            <thead>
                                <tr>
                                <th scope="col">#</th>
                                <th scope="col">Khung giờ sale's</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($sales as $item => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('sale.edit', ['sale' => $value->id])}}" class="edit-icon"><i class="fa-solid fa-pen"></i></a>

                                            <form action="{{route('sale.destroy',['sale' => $value->id])}}" method="post" style="display: inline-block">
                                                @method("DELETE")
                                                @csrf
